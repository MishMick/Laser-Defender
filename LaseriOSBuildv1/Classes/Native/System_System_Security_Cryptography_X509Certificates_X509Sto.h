...
struct  X509Store_t952  : public Object_t
{
	...
	X509Certificate2Collection_t945 * ___list_2;
...
struct X509Store_t952_StaticFields{
	...
	Dictionary_2_t396 * ___U3CU3Ef__switchU24mapF_5;
};
