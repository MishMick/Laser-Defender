...
struct ThreadSafeDictionaryValueFactory_2_t652;
...
struct  ThreadSafeDictionary_2_t653  : public Object_t
{
	...
	ThreadSafeDictionaryValueFactory_2_t652 * ____valueFactory_1;
