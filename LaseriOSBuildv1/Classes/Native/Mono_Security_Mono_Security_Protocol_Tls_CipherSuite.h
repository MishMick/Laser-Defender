...
struct  CipherSuite_t775  : public Object_t
{
	...
	SymmetricAlgorithm_t689 * ___decryptionAlgorithm_17;
...
struct CipherSuite_t775_StaticFields{
	// System.Byte[] Mono.Security.Protocol.Tls.CipherSuite::EmptyArray
	ByteU5BU5D_t416* ___EmptyArray_0;
};
